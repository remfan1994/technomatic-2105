...
```text
FOREGROUND_SERVICE: keeps audio playback alive in the background.
POST_NOTIFICATIONS: shows playback controls on Android 13+.
WAKE_LOCK: helps keep generated audio running while the screen is off.
```
