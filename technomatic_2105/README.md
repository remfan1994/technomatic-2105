...
v0.22.0 keeps the v11-v19 engine improvements and adds a genre-isolation/history stability pass:
...
git init
git add .
git commit -m "Technomatic 2105 0.22.0"
git branch -M main
...
Before submitting to F-Droid, replace repository URL placeholders if your GitHub path is not `r94/technomatic-2105`, push the `v0.22.0` tag, and verify that F-Droid can build the release from source.
