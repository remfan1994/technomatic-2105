...
int main() {
    ...
    // recognizable overlapping pad pulse around 1:27. v26 preserves the same
    ...
    const std::string pcmPath = "/tmp/technomatic_v26_export_test.pcm";
    ...
    std::cout << (ok ? "PASS v26 validation\n" : "FAIL v26 validation\n");
    return ok ? 0 : 1;
}
